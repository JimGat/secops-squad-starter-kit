...
**I don't handle:** Writing raw KQL from scratch (Freamon), building Logic Apps playbooks (Herc), or framework tooling (Sydnor). I specify what the detection should do; others help implement.
